import type { AIModel, Comment, ModelPromptResponse } from "@/types/model"
    ...
    comments: [
      {
        ...
        content:
          "Extremely useful for summarizing long NDAs. Saved me hours of reading today!",
        rating: 5,
      ...
      },
      {
        ...
        content:
          "Very accurate, although sometimes it misses specific local jurisdiction nuances.",
        rating: 4,
    ...
    comments: [
      {
        ...
        content:
          "Impressive diagnostic assistance. It's a great tool for cross-referencing rare symptoms.",
        rating: 5,
...
export const modelService = {
  ...
  async addComment(
    ...
    if (model) {
      ...
      const currentRating = model.rating || 0
      const currentCount = model.reviewCount || 0
      model.rating =
        (currentRating * currentCount + comment.rating) / (currentCount + 1)
      model.reviewCount = currentCount + 1
    }
    return newComment
  },
}
